...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_calendarView_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_calendarView_t qt_meta_stringdata_calendarView = {
    {
QT_MOC_LITERAL(0, 0, 12), // "calendarView"
QT_MOC_LITERAL(1, 13, 10), // "incremente"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 10) // "decremente"

    },
    "calendarView\0incremente\0\0decremente"
};
...
void calendarView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->incremente(); break;
        case 1: _t->decremente(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject calendarView::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_calendarView.data,
      qt_meta_data_calendarView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *calendarView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_calendarView.stringdata))
        return static_cast<void*>(const_cast< calendarView*>(this));
